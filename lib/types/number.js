...
module.exports = Any.extend({
    ...
    messages: {
        /**
         * @category errors
         * @summary The value is not a number or could not be cast to a number.
         */
        'number.base': '{{#label}} must be a number',
        /**
         * @category errors
         * @summary The number is lower or equal to the limit that you set.
        ...
        /**
         * @category errors
         * @summary The number is `Infinity` or `-Infinity`.
         */
        'number.infinity': '{{#label}} cannot be infinity',
        /**
         * @category errors
         * @summary The number is not a valid integer.
         */
        'number.integer': '{{#label}} must be an integer',
        /**
         * @category errors
         * @summary The number is higher or equal to the limit that you set.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The number is higher than the limit that you set.
         * @description Additional local context properties:
         * ```ts
         * {
         *     limit: number // Maximum value that was expected for this number
        ...
        /**
         * @category errors
         * @summary The number is lower than the limit that you set.
         * @description Additional local context properties:
         * ```ts
         * {
         *     limit: number // Minimum value that was expected for this number
        ...
        /**
         * @category errors
         * @summary The number could not be divided by the multiple you provided.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The number was positive.
         */
        'number.negative': '{{#label}} must be a negative number',
        /**
         * @category errors
         * @summary The number didn't look like a port number.
         */
        'number.port': '{{#label}} must be a valid port',
        /**
         * @category errors
         * @summary The number was negative.
         */
        'number.positive': '{{#label}} must be a positive number',
        /**
         * @category errors
         * @summary The number didn't have the required precision.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The number is not within the safe range of JavaScript numbers.
         */
