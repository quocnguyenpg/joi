...
module.exports = Any.extend({
    ...
    messages: {
        /**
         * @category errors
         * @summary The value did not match all of the alternative schemas.
         */
        'alternatives.all': '{{#label}} does not match all of the required types',
        /**
         * @category errors
         * @summary No alternative was found to test against the input due to try criteria.
         */
        'alternatives.any': '{{#label}} does not match any of the allowed types',
        /**
         * @category errors
         * @summary No alternative matched the input due to specific matching rules for at least one of the alternatives.
        ...
        /**
         * @category errors
         * @summary The value matched more than one alternative schema.
         */
        'alternatives.one': '{{#label}} matches more than one allowed type',
        /**
         * @category errors
         * @summary The provided input did not match any of the allowed types.
         * @description Additional local context properties:
         * ```ts
         * {
