...
module.exports = Any.extend({
    ...
    messages: {
        /**
         * @category errors
         * @summary The AND condition between the properties you specified was not satisfied in that object.
        ...
        /**
         * @category errors
         * @summary The schema on an [`object.assert()`](#objectassertref-schema-message) failed to validate.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The value is not of the expected type.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The object is not of the type you specified.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The number of keys for this object is not of the expected length.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The number of keys for this object is over or equal to the limit that you set.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The number of keys for this object is under or equal to the limit that you set.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The OR or XOR condition between the properties you specified was not satisfied in that object,
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The NAND condition between the properties you specified was not satisfied in that object.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The optional XOR condition between the properties you specified was not satisfied in that object.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The object keys failed to match a pattern's matches requirement.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The object is not a [`Joi.ref()`](#refkey-options).
         */
        'object.refType': '{{#label}} must be a Joi reference',
        /**
         * @category errors
         * @summary The object is not a `RegExp` object.
         */
        'object.regex': '{{#label}} must be a RegExp object',
        /**
         * @category errors
         * @summary Another rename was already done to the same target property.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The target property already exists and you disallowed overrides.
         * @description Additional local context properties:
         * ```ts
         * {
         *     from: string, // Origin property name of the rename
        ...
        /**
         * @category errors
         * @summary The object was not a **joi** schema.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary An unexpected property was found in the object.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary Property that should have been present at the same time as another one was missing.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary Property that should have been absent at the same time as another one was present.
         * @description Additional local context properties:
         * ```ts
         * {
         *     main: string, // Property that triggered the check
        ...
        /**
         * @category errors
         * @summary The XOR condition between the properties you specified was not satisfied in that object.
         * @description Additional local context properties:
         * ```ts
         * {
