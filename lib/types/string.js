...
module.exports = Any.extend({
    ...
    messages: {
        /**
         * @category errors
         * @summary The string doesn't only contain alphanumeric characters.
         */
        'string.alphanum': '{{#label}} must only contain alpha-numeric characters',
        /**
         * @category errors
         * @summary The input is not a string.
         */
        'string.base': '{{#label}} must be a string',
        /**
         * @category errors
         * @summary The string isn't a valid base64 string.
         */
        'string.base64': '{{#label}} must be a valid base64 string',
        /**
         * @category errors
         * @summary The string is not a valid credit card number.
         */
        'string.creditCard': '{{#label}} must be a credit card',
        /**
         * @category errors
         * @summary The string is not a valid data URI.
         */
        'string.dataUri': '{{#label}} must be a valid dataUri string',
        /**
         * @category errors
         * @summary The string is not a valid domain name.
         */
        'string.domain': '{{#label}} must contain a valid domain name',
        /**
         * @category errors
         * @summary The string is not a valid e-mail.
        ...
        /**
         * @category errors
         * @summary When an empty string is found and denied by invalid values.
         */
        'string.empty': '{{#label}} is not allowed to be empty',
        /**
         * @category errors
         * @summary The string is not a valid GUID.
         */
        'string.guid': '{{#label}} must be a valid GUID',
        /**
         * @category errors
         * @summary The string is not a valid hexadecimal string.
         */
        'string.hex': '{{#label}} must only contain hexadecimal characters',
        /**
         * @category errors
         * @summary The string contains hexadecimal characters but they are not byte-aligned.
         */
        'string.hexAlign': '{{#label}} hex decoded representation must be byte aligned',
        /**
         * @category errors
         * @summary The string is not a valid hostname.
         */
        'string.hostname': '{{#label}} must be a valid hostname',
        /**
         * @category errors
         * @summary The string is not a valid IP address.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The string is not a valid IP address considering the provided constraints.
         * @description Additional local context properties:
         * ```ts
         * {
         *     cidr: string, // CIDR used for the validation
        ...
        /**
         * @category errors
         * @summary The string is not a valid ISO date string.
         */
        'string.isoDate': '{{#label}} must be in iso format',
        /**
         * @category errors
         * @summary The string must be a valid ISO 8601 duration.
         */
        'string.isoDuration': '{{#label}} must be a valid ISO 8601 duration',
        /**
         * @category errors
         * @summary The string is not of the expected length.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The string isn't all lower-cased.
         */
        'string.lowercase': '{{#label}} must only contain lowercase characters',
        /**
         * @category errors
         * @summary The string is longer than expected.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The string is shorter than expected.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The string isn't valid in regards of the normalization form expected.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The string didn't match the regular expression.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The string didn't match the named regular expression.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The string matched the regular expression while it shouldn't.
         * @description Additional local context properties:
         * ```ts
         * {
         *     name: undefined, // Undefined since the regular expression has no name
        ...
        /**
         * @category errors
         * @summary The string matched the named regular expression while it shouldn't.
         * @description Additional local context properties:
         * ```ts
         * {
         *     name: string, // Name of the regular expression
        ...
        /**
         * @category errors
         * @summary The string isn't a token.
         */
        'string.token': '{{#label}} must only contain alpha-numeric and underscore characters',
        /**
         * @category errors
         * @summary The string contains whitespace around it.
         */
        'string.trim': '{{#label}} must not have leading or trailing whitespace',
        /**
         * @category errors
         * @summary The string isn't all upper-cased.
         */
        'string.uppercase': '{{#label}} must only contain uppercase characters',
        /**
         * @category errors
         * @summary The string isn't a valid URI.
         */
        'string.uri': '{{#label}} must be a valid uri',
        /**
         * @category errors
         * @summary The string isn't a valid URI considering the custom schemes.
         * @description Additional local context properties:
         * ```ts
         * {
        ...
        /**
         * @category errors
         * @summary The string is a valid relative URI.
         */
